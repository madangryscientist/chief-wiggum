...
export const ChiefWiggumPlugin: Plugin = async (ctx) => {
	return {
		tool: {
			chief_wiggum_status: status,
			chief_wiggum_start_loop: start_loop,
			chief_wiggum_complete_iteration: complete_iteration,
			chief_wiggum_next_task: next_task,
			chief_wiggum_get_context: get_context,
			chief_wiggum_mark_task: mark_task,
			chief_wiggum_stop: stop,
		},
	};
};
